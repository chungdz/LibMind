...
CUDA_VISIBLE_DEVICES=4,5,6,7 python training.py --gpus=4 --max_hist_length=4 --epoch=1 --model=dfm
CUDA_VISIBLE_DEVICES=4,5,6,7 python validate.py --gpus=4 --max_hist_length=4 --epoch=0 --filenum=40 --model=dfm
