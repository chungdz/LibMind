...
CUDA_VISIBLE_DEVICES=4,5,6,7 python training.py --gpus=4 --max_hist_length=30 --epoch=4 --model=ctr_dfm --batch_size=256 --port=9440 --root=Adressa --max_title=15 --vtype=test
