...
python build_train_adressa.py --processes=10 --ftype=dev --max_hist_length=10 --root=Adressa --fsamples=dev_behaviors.tsv --max_title=15
python build_train_adressa.py --processes=10 --ftype=test --max_hist_length=10 --root=Adressa --fsamples=test_behaviors.tsv --max_title=15
CUDA_VISIBLE_DEVICES=4,5,6,7 python training.py --gpus=4 --max_hist_length=10 --epoch=4 --model=ctr_dfm --batch_size=256 --port=9440 --root=Adressa --max_title=15 --vtype=test
